...
function TaskCard({ priority, eta, title, loc, team, responders, active, unassigned }: any) {
  return (
...
function VolunteerItem({ name, dist, skills }: any) {
  return (
...
function ShelterCard({ name, value, total, danger }: any) {
  return (
...
function DispatchButton({ icon, label }: any) {
  return (
