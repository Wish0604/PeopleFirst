...
function AlertCard({ priority, time, title, desc, active, dim }: any) {
  return (
...
function MetricBar({ label, value, status, color }: any) {
  return (
...
function StatusIndicator({ label, status, online }: any) {
  return (
...
function ActivityItem({ icon, text, time, color, last }: any) {
  return (
