...
function StatusToggleButton({ label, active }: any) {
  return (
...
function ActivityLogItem({ name, text, time, color }: any) {
  return (
...
function VolunteerRow({ name, loc, status, skills, avail, sync }: any) {
  return (
...
function NearestItem({ name, info, abbr, color }: any) {
  return (
...
function ZoneSupportItem({ zone, needed, current, progress, urgent }: any) {
  return (
...
function SkillCheckbox({ label }: any) {
  return (
